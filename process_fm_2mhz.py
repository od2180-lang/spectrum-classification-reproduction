#!/usr/bin/env python3
"""
Step 2-3: Process FM Files (2 MHz)
Classify all 41 FM files using center 200-bin (2 MHz) chunks.
"""
...
def process_fm_files_2mhz():
    """Process all FM files with 2 MHz extraction and calculate accuracy."""
    print("=" * 60)
    print("Step 2-3: Process FM Files (2 MHz)")
    print("=" * 60)
...
if __name__ == "__main__":
    results, correct, total = process_fm_files_2mhz()