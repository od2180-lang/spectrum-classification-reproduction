#!/usr/bin/env python3
"""
Step 7: Process TETRA Files
Classify all 38 TETRA files using full band approach.
"""
...
def process_tetra_files():
    """Process all TETRA files and calculate accuracy."""
    print("=" * 60)
    print("Step 7: Process TETRA Files (Full Band)")
    print("=" * 60)
...
if __name__ == "__main__":
    results, correct, total = process_tetra_files()
